...
// GetInitParameters of this BareMetalServer
func (tr *BareMetalServer) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BareMetalServer
func (tr *BareMetalServer) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
