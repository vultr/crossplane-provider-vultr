...
// GetInitParameters of this NodePools
func (tr *NodePools) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NodePools
func (tr *NodePools) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
