...
type ForwardingRulesInitParameters struct {
...
type LoadBalancerInitParameters struct {
	...
	FirewallRules []FirewallRulesInitParameters `json:"firewallRules,omitempty" tf:"firewall_rules,omitempty"`

	// List of forwarding rules for a load balancer. The configuration of a forwarding_rules is listened below.
	ForwardingRules []ForwardingRulesInitParameters `json:"forwardingRules,omitempty" tf:"forwarding_rules,omitempty"`
...
type LoadBalancer struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.forwardingRules) || (has(self.initProvider) && has(self.initProvider.forwardingRules))",message="spec.forProvider.forwardingRules is a required parameter"
