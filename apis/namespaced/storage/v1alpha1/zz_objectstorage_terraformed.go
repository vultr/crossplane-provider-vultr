...
// GetInitParameters of this ObjectStorage
func (tr *ObjectStorage) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ObjectStorage
func (tr *ObjectStorage) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
