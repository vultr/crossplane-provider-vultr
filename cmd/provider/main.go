...
import (
	...
	apisCluster "github.com/crossplane-contrib/provider-vultr/apis/cluster"
	apisNamespaced "github.com/crossplane-contrib/provider-vultr/apis/namespaced"
	"github.com/crossplane-contrib/provider-vultr/config"
	"github.com/crossplane-contrib/provider-vultr/internal/clients"
	controllerCluster "github.com/crossplane-contrib/provider-vultr/internal/controller/cluster"
	controllerNamespaced "github.com/crossplane-contrib/provider-vultr/internal/controller/namespaced"
	"github.com/crossplane-contrib/provider-vultr/internal/features"
	"github.com/crossplane-contrib/provider-vultr/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Vultr APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced Vultr APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped Vultr controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced Vultr controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped Vultr controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced Vultr controllers")
	}
